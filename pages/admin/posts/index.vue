  ...
  <div>
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
      <div class="flex items-center gap-3 min-w-0">
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Tin tức &amp; Sự kiện</h1>
        <button
      ...
      <NuxtLink to="/admin/posts/create" class="btn-primary inline-flex items-center gap-2 shrink-0">
