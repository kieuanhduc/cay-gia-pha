<template>
  <div class="max-w-3xl mx-auto px-4 py-10">
    <NuxtLink to="/news" class="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-gray-700 mb-6">
    ...
    <article v-else>
      ...
      <div class="flex items-center gap-2 text-sm text-gray-400 mb-3">
        <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">
          <Icon name="ph:newspaper-bold" class="text-[10px]" />Tin tức
        </span>
        <span>&middot;</span>
