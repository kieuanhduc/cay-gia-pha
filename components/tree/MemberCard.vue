<template>
  ...
  >
    <div v-if="member" class="fixed right-0 top-0 bottom-0 w-80 bg-white shadow-2xl z-50 overflow-y-auto">
...
const defaultAvatar = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect fill="%23e5e7eb" width="100" height="100" rx="50"/><text x="50" y="60" text-anchor="middle" fill="%239ca3af" font-size="30">?</text></svg>`
